...
from utils.constants import LUZ, INDUSTRIAL_TOTAL_SQUARE_FOOTAGE, \
...
def export_luz_data(frame):
    ...
    output_frame.sort_values(by=['Commodity', 'LUZ'], inplace=True)
