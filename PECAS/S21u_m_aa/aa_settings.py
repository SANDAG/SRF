...
# The name of the database schema where data tables for this run are stored.
# Usually this is the name of the scenario with the initial letter in lowercase, e.g. "w25" or "s14b".
#sd_schema = "s21"
