...
if __name__ == "__main__":
    ...
    dump_pg_tbls(lambda: pr.connect_to_aa(ps=main_ps), ".", input_schema,'^Inputs_')  #download table in Inputs folder
    dump_pg_tbls(lambda: pr.connect_to_aa(ps=main_ps), ".", input_schema,'^\d+') #download yearly inputs
